...
import com.wang.container.utils.getDefLayoutParams

open class ListAdapterHelper<BEAN>(
    ...
    fun <VB : ViewBinding> onCreateDefaultViewHolder(parent: ViewGroup, obj: Any) =
        BaseViewHolder(ViewBindingHelper.getViewBindingInstance<VB>(obj, LayoutInflater.from(parent.context), parent))
